...
parser.add_argument("-train_path", type=str, default="/home/lhy/modelnet10_20/*/train")
#parser.add_argument("-train_path", type=str, default="/home/student/lhy/modelnet40_20/*/train")
parser.add_argument("-val_path", type=str, default="/home/lhy/modelnet10_20/*/test")
...
if __name__ == '__main__':
    ...
    '''optimizer = optim.SGD(cnet.parameters(), lr=1e-2, weight_decay=0.001, momentum=0.9)
    ...
    create_folder(log_dir)
    cnet_2 = view_GCN(args.name, cnet, nclasses=10, cnn_name=args.cnn_name, num_views=args.num_views)
